...
mkdir -p "$link_repo/spec/bootstrap" "$link_repo/skills/deep-test"
cp "$SCRIPT_DIR/../spec/bootstrap/link-skills.sh" "$link_repo/spec/bootstrap/link-skills.sh"
chmod +x "$link_repo/spec/bootstrap/link-skills.sh"
...
subdir_target="$(readlink "$link_repo/.claude/skills/deep-test.md")"
...
assert_equals "link-skills subdir skill is relative" "../../skills/deep-test/SKILL.md" "$subdir_target"
...
mkdir -p "$source_repo/spec/bootstrap" "$source_repo/skills"
cp "$SCRIPT_DIR/../spec/bootstrap/install-harness.sh" "$source_repo/spec/bootstrap/install-harness.sh"
chmod +x "$source_repo/spec/bootstrap/install-harness.sh"
