...
.context/baton/
  ├── README.md
  └── active/
      ├── slices/            # Builder packet / report / patch scratch state
...
- Builder may write slice packets, worker reports, and temporary patches here, but must still update canonical state itself.
