...
- Are sources classified by type (official docs, source code, spec, peer-reviewed, community, blog)?
- Is the Source Landscape section present and substantive?
...
- Do Final Conclusions each include: confidence, primary source citation, applicability, verification path?
