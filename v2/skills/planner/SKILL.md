...
| `v2/skills/planner/planning.md` | Round 1 and Round N planning | Context read, exploration, clarification, decomposition, approach design, ACs, batch plan |
...
- `§ Round N` — ACs, decisions, `§ Open Decisions`, approach, batch plan, risks
...
5. Batch plan is mandatory. Builder needs explicit file groupings and validation checkpoints.
