...
required_for_state() {
  case "$1" in
    ...
    generating|reviewing) echo "scoped-map.md requirements.md architecture.md verification-path.md" ;;
    ready_for_human_close|complete) echo "scoped-map.md requirements.md architecture.md verification-path.md evaluation.md" ;;
    *)                    echo "" ;;
  esac
}
